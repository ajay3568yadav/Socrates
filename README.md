...
We welcome contributions to expand our dataset and improve the CUDA tutoring experience! Areas for contribution:

1. **Dataset Enhancement**: Adding more CUDA examples and benchmarks
2. **Performance Optimization**: Improving RAG retrieval accuracy
3. **Educational Content**: Creating structured learning paths
4. **Evaluation Metrics**: Developing better assessment tools

## 📄 License

This project is licensed under [Your License] - see the LICENSE file for details.

The datasets used are subject to their respective licenses:
- SakanaAI AI-CUDA-Engineer-Archive: CC-By-4.0
- NVIDIA CUDA Samples: Various licenses (see repository)
- Rodinia Benchmark Suite: Academic use license
