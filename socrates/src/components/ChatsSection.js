...
const ChatsSection = ({ 
  ...
  const getChatPreview = (chat) => {
    if (chat.description && chat.description !== 'Start a new conversation about CUDA programming' && chat.description !== 'Chat conversation') {
    ...
    <div className="folder-section">
      <div className="section-header">
        ...
        <div className="section-actions">
          ...
          <button className="section-action" title="Chat options">⋯</button>
        </div>
      </div>
            ...
            <div className="chat-item">
              ...
              <div className="chat-content">
                ...
                <div className="chat-preview">
                  {selectedModuleId ? 'Loading module chats...' : 'Please wait while we load your conversations'}
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="chat-item">
              ...
              <div className="chat-content">
                <div className="chat-title">
                  {selectedModuleId ? 'No chats in this module' : 'No chats yet'}
                </div>
                <div className="chat-preview">
                  {selectedModuleId 
      ...
      {chats.length > 0 && (
        <div className="modules-summary">
          <div className="summary-text">
            {chats.filter(chat => chat.status === 'active').length} active • {chats.length} total
          </div>
        </div>
      )}
    </div>
